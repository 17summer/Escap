...
public class Boss : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bossSight = transform.Find("BossSight").GetComponent<BossSight>();
    ...
    void Chasing()
    {
        ...
        Vector3 sightDeltPos = bossSight.playerLastSight - transform.position;
        if (sightDeltPos.sqrMagnitude > sqrPlayerDist)
            agent.destination = bossSight.playerLastSight;
